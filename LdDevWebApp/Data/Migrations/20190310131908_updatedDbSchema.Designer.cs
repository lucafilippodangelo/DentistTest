...
namespace LdDevWebApp.Data.Migrations
{
    ...
    [Migration("20190310131908_updatedDbSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LdDevWebApp.Models.Entities.AppointmentStaff_NtoN", b =>
                {
                    b.Property<Guid>("AppointmentStaff_NtoN_giudId")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("giudAptId");

                    b.Property<Guid>("giudStaffId");

                    b.Property<Guid?>("staffgiudPersonId");

                    b.HasKey("AppointmentStaff_NtoN_giudId");

                    b.HasIndex("giudAptId");

                    b.HasIndex("staffgiudPersonId");

                    b.ToTable("AppointmentStaff_NtoN");
                });
            ...
            modelBuilder.Entity("LdDevWebApp.Models.Entities.Patient", b =>
                {
                    ...
                    b.HasIndex("giudAptId")
                        .IsUnique()
                        .HasFilter("[giudAptId] IS NOT NULL");
            ...
            modelBuilder.Entity("LdDevWebApp.Models.Entities.AppointmentStaff_NtoN", b =>
                {
                    b.HasOne("LdDevWebApp.Models.Entities.Appointment", "appointment")
                        .WithMany("appointmentStaff_NtoN")
                        .HasForeignKey("giudAptId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LdDevWebApp.Models.Entities.Staff", "staff")
                        .WithMany("appointmentStaff_NtoN")
                        .HasForeignKey("staffgiudPersonId");
                });

            modelBuilder.Entity("LdDevWebApp.Models.Entities.Practise", b =>
                {
                    b.HasOne("LdDevWebApp.Models.Entities.Appointment", "AppointmentNavigation")
                        .WithOne("practise")
                        .HasForeignKey("LdDevWebApp.Models.Entities.Practise", "giudAptId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("LdDevWebApp.Models.Entities.TreatmentType", b =>
                {
                    b.HasOne("LdDevWebApp.Models.Entities.Appointment", "AppointmentNavigation")
                        .WithOne("aptTreatmentType")
                        .HasForeignKey("LdDevWebApp.Models.Entities.TreatmentType", "giudAptId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("LdDevWebApp.Models.Entities.Patient", b =>
                {
                    b.HasOne("LdDevWebApp.Models.Entities.Appointment", "AppointmentNavigation")
                        .WithOne("aptPatient")
                        .HasForeignKey("LdDevWebApp.Models.Entities.Patient", "giudAptId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
